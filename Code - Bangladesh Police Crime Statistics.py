...
"""# **Interactive Time-Series and Regional Comparisons**
...
"""# **Build Dashboards To Track Crime**
...
display(Ml_df_time_series_filtered.head())
...
top_overall_crimes = sorted(crime_totals.items(), key=lambda x: x[1], reverse=True)[:5]
